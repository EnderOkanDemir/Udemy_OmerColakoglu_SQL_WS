...
- If we write a query to retrieve data from an unselected database, we need to specify the database name.
...
- If a column name contains spaces or special characters, you must use delimiters (such as square brackets in SQL Server) around the column name in every query.
